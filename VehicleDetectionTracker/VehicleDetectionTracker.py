...
class VehicleDetectionTracker:
    ...
    def process_frame(self, frame, frame_timestamp):
        ...
        response = {
            ...
            "last_detected_vehicle_id": None,  # ID of the last detected vehicle
            "total_detected_vehicles": 0  # Total number of detected vehicles
        }
        ...
        if results is not None and results[0] is not None and results[0].boxes is not None and results[0].boxes.id is not None:
            ...
            for box, track_id, cls, conf in zip(boxes, track_ids, clss, conf_list):
                ...
                # Update the last detected vehicle ID
                response["last_detected_vehicle_id"] = track_id
        ...
        # Update total detected vehicles count
        response["total_detected_vehicles"] = len(self.detected_vehicles)
